...
class Trader:
    ...
    def merle_trade_vouchers(self: "Trader", state: TradingState,
        ...
        for K, symbol in {
            ...
            # rock_orders = book[Product.VOLC_ROCK]
            # rock_order_depth = state.order_depths[Product.VOLC_ROCK]
            # voucher_position = state.position.get(symbol, 0)
